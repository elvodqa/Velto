...
public class InputOverlayView : View
{
    ...
    public override void Draw(double delta)
    {
        ...
        _renderer.DrawTexture(_gameView.Skin.InputOverlayBackground, Width/2, Height/2, 
            _gameView.Skin.InputOverlayBackground.Width, _gameView.Skin.InputOverlayBackground.Handle, new Vector4(1, 1, 1, 1), 90f * MathHelper.DegToRad);
    }
