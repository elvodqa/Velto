...
public class InputOverlayView : View
{
    ...
    public override void Draw(double dt, Renderer r)
    {
        ...
        _renderer.DrawCenteredTexture(_gameView.Skin.InputOverlayBackground, new(Width - bgTextureHeight/2, Height/2), 
            bgTextureWidth, bgTextureHeight, new Color4<Rgba>(1, 1, 1, 1), 270);
        ...
        _renderer.DrawCenteredTexture(keyTexture, points[0], bgTextureHeight*ratioH, bgTextureWidth*ratioW, new Color4<Rgba>(1, 1, 1, 1), 0);
